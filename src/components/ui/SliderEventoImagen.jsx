...
const SliderEventoImagen = () => {
    ...
    return (
        <div className="relative w-full md:w-4/5 h-[80dvh] mx-auto">
            <img
                src={bgImages[currentImageIndex].src}
                alt={bgImages[currentImageIndex].alt}
                className={`w-full h-3/4 md:h-full shadow-lg  rounded-md object-cover absolute transition-opacity duration-1000 ${
